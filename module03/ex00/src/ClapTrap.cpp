...
/*   Updated: 2021/09/10 22:23:31 by mleblanc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("Bob"), hitpoints(10), energy(10), damage(0)
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    std::cout << "ClapTrap repaired " << amount << " hitpoints using " << amount
              << " energy!\n";
}
